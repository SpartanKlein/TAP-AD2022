...
public class Productor implements Runnable
{
   ...
   public void run()                             
   {
      ...
      while ((horaActual - horaInicial) <= DIEZ_MINUTOS )
      {
         ...
         {
            Thread.sleep( generador.nextInt( DIEZ_SEGUNDOS ) ); // periodo de inactividad aleatorio
            int tipoServicio = generador.nextInt( (3) + 1);
            ubicacionCompartida.establecer( tipoServicio ); // establece el valor en el b�fer
