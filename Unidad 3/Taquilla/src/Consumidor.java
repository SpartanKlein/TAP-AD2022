...
public class Consumidor  implements Runnable {
    ...
    private final int UN_MINUTO = 1000 * 30; //milisegundos * segundos * minutos
    private final int CUATRO_MINUTOS = 1000 * 40  ; //milisegundos * segundos * minutos
    ...
    public void run()
    {
        ...
        while ( ( ( horaActual - horaInicial ) <= DOCE_HORAS) || !ubicacionCompartida.estaVacio())
        {
            try // permanece inactivo de 0 a 3 segundos, despu�s coloca valor en Bufer
            {
                Thread.sleep( CUATRO_MINUTOS + generador.nextInt(UN_MINUTO) ); // periodo de inactividad aleatorio
        ...
        System.out.printf("\tNo.de Sala\tCantidad Clientes atendidos\n");
